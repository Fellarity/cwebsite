      ...
      where: { 
        ...
        ...(query ? {
          OR: [
            ...
            { tutorProfile: { expertise: { has: query } } }
          ]
        } : {})
      },
      include: {
    ...
    <main className="min-h-screen pb-20">
      ...
      <section className="pt-40 pb-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
            ...
            <form action={handleSearch} className="flex items-center gap-3">
              ...
              <button type="submit" className="px-6 py-4 bg-brand-primary text-white rounded-2xl font-black text-xs uppercase tracking-widest hover:bg-brand-primary-hover transition-all shadow-lg shadow-brand-soft">
                Search
              </button>
            </form>
          </div>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          {tutors.length === 0 ? (
            <div className="text-center py-20 bg-white/50 rounded-[3rem] border-2 border-dashed border-sky-100">
               <p className="text-slate-500 font-bold uppercase tracking-widest">No tutors found matching "{query}"</p>
               <Link href="/tutors" className="text-brand-primary font-black text-xs uppercase mt-4 inline-block hover:underline">Clear all filters</Link>
            </div>
          ) : (
